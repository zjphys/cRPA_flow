...
""",
    ...
    def test_adaptive_cli_generates_frozen_window_and_passes_options(self) -> None:
        ...
        self.assertAlmostEqual(report["outer_quantiles"]["probabilities"][0], 0.025)
        self.assertAlmostEqual(report["outer_quantiles"]["probabilities"][1], 0.975)
        self.assertIn("local 2.5%-97.5% cumulative-weight intervals", result.stdout)
